...
public class WeatherORamaView extends JFrame {
    ...
    public void seccionCurrentConditions() {
        lbl_V_Temperatura.setVisible(true);
        lbl_V_Humedad.setVisible(true);
    }

    public void seccionStatistics() {
        lbl_V_ResultadoEstadisticas.setVisible(true);
    }

    public void seccionForecast() {
        lbl_V_ResultadoPronostico.setVisible(true);
    }

    public void seccionAQI() {
        lbl_V_ResultadoCalidadAire.setVisible(true);
    }
    ...
    public WeatherORamaView() {
        ...
        lbl_V_Temperatura.setVisible(false);
        lbl_V_Humedad.setVisible(false);
        lbl_V_ResultadoEstadisticas.setVisible(false);
        lbl_V_ResultadoPronostico.setVisible(false);
        lbl_V_ResultadoCalidadAire.setVisible(false);
    ...
    private void make_Visualizations(JPanel visualizationsPanel) {
        ...
        lbl_V_ResultadoEstadisticas.setBounds(10, 100, 500, 20);
    ...
    public void setEstadisticas(float prom, float max, float min) {
        String estadisticas = String.format("Prom: %.1f°C | Máx: %.1f°C | Mín: %.1f°C", prom, max, min);
        lbl_V_ResultadoEstadisticas.setText(estadisticas);
    }
    ...
    public void setCalidadAire(String texto) {
        lbl_V_ResultadoCalidadAire.setText("<html><span style='color: red;'>" + texto + "</span></html>");
    }
